...
We successfully generated *K*<sub>D,app</sub> estimates for `r round(sum(!is.na(dt$Kd_huACE2))/nrow(dt)*100,digits=2)`% of our lib1+lib2 huACE2 titrations, `r round(sum(!is.na(dt$Kd_cvACE2))/nrow(dt)*100,digits=2)`% of our lib1+lib2 cvACE2 titrations, `r round(sum(!is.na(dt$Kd_pgACE2))/nrow(dt)*100,digits=2)`% of our lib1+lib2 pgACE2 titrations, `r round(sum(!is.na(dt$Kd_RaACE2.787))/nrow(dt)*100,digits=2)`% of our lib1+lib2 RaACE2.787 titrations, `r round(sum(!is.na(dt$Kd_RaACE2.9479))/nrow(dt)*100,digits=2)`% of our lib1+lib2 RaACE2.9479 titrations, `r round(sum(!is.na(dt$Kd_RsACE2.3364))/nrow(dt)*100,digits=2)`% of our lib1+lib2 RsACE2.3364 titrations, and `r round(sum(!is.na(dt$Kd_RsACE2.1434))/nrow(dt)*100,digits=2)`% of our lib1+lib2 RsACE2.1434 titrations.
...
```{r Kd_distribution, fig.width=5, fig.height=22, fig.align="center",dpi=300,dev="png"}
par(mfrow=c(10,1))
...
```{r final_pheno_DFE, fig.width=10, fig.height=32, fig.align="center",dpi=300,dev="png"}
