...
fit.titration <- function(y.vals,x.vals,count.vals,min.cfu=cutoff,
  ...
  if((length(y) < min.means*length(y.vals)) | (mean(count.vals,na.rm=T) < min.average)){ #return NAs if < min.means fraction of concentrations have above min.cfu counts or if the average count across all concentrations is below min.average
    ...
    fit <- nls(y ~ a*(x/(x+Kd))+b,
               ...
               upper=list(a=a.upper,b=b.upper,Kd=max(x.vals[x.vals>0])), #constrain Kd to be no higher than the highest concentration value
               algorithm="port")  
...
```{r avgcount, fig.width=12, fig.height=6, fig.align="center",dpi=300,dev="png"}
par(mfrow=c(2,4))
hist(log10(dt[!is.na(Kd_huACE2),huACE2_avgcount]+0.5),breaks=20,xlim=c(0,5),main="huACE2",col="gray50",xlab="average cell count across concentration samples")
hist(log10(dt[is.na(Kd_huACE2),huACE2_avgcount]+0.5),breaks=30,add=T,col="red")

hist(log10(dt[!is.na(Kd_RaACE2),RaACE2_avgcount]+0.5),breaks=20,xlim=c(0,5),main="RaACE2",col="gray50",xlab="average cell count across concentration samples")
hist(log10(dt[is.na(Kd_RaACE2),RaACE2_avgcount]+0.5),breaks=30,add=T,col="red")

hist(log10(dt[!is.na(Kd_RpACE2),RpACE2_avgcount]+0.5),breaks=20,xlim=c(0,5),main="RpACE2",col="gray50",xlab="average cell count across concentration samples")
hist(log10(dt[is.na(Kd_RpACE2),RpACE2_avgcount]+0.5),breaks=30,add=T,col="red")

hist(log10(dt[!is.na(Kd_RsACE2),RsACE2_avgcount]+0.5),breaks=20,xlim=c(0,5),main="RsACE2",col="gray50",xlab="average cell count across concentration samples")
hist(log10(dt[is.na(Kd_RsACE2),RsACE2_avgcount]+0.5),breaks=30,add=T,col="red")

hist(dt[!is.na(Kd_huACE2),huACE2_min_cell_filtered],breaks=2,main="huACE2",col="gray50",xlab="number of sample concentrations below cutoff cell number",xlim=c(0,9))
hist(dt[is.na(Kd_huACE2),huACE2_min_cell_filtered],breaks=10,add=T,col="red")

hist(dt[!is.na(Kd_RaACE2),RaACE2_min_cell_filtered],breaks=2,main="RaACE2",col="gray50",xlab="number of sample concentrations below cutoff cell number",xlim=c(0,9))
hist(dt[is.na(Kd_RaACE2),RaACE2_min_cell_filtered],breaks=10,add=T,col="red")

hist(dt[!is.na(Kd_RpACE2),RpACE2_min_cell_filtered],breaks=2,main="RpACE2",col="gray50",xlab="number of sample concentrations below cutoff cell number",xlim=c(0,9))
hist(dt[is.na(Kd_RpACE2),RpACE2_min_cell_filtered],breaks=10,add=T,col="red")

hist(dt[!is.na(Kd_RsACE2),RsACE2_min_cell_filtered],breaks=2,main="RsACE2",col="gray50",xlab="number of sample concentrations below cutoff cell number",xlim=c(0,9))
hist(dt[is.na(Kd_RsACE2),RsACE2_min_cell_filtered],breaks=10,add=T,col="red")
...
```{r 1e-4_Kd, fig.width=8, fig.height=8, fig.align="center",dpi=300, warning=FALSE, results=FALSE,dev="png"}
par(mfrow=c(2,2))
...
par(mfrow=c(2,2))
plot.titration.huACE2(which(dt$Kd_huACE2 > 1e-5 & dt$Kd_huACE2 < 1.2e-5)[1])
plot.titration.RaACE2(which(dt$Kd_RaACE2 > 1e-5 & dt$Kd_RaACE2 < 1.2e-5)[1])
plot.titration.RpACE2(which(dt$Kd_RpACE2 > 9e-6 & dt$Kd_RpACE2 < 1.2e-5)[1])
plot.titration.RsACE2(which(dt$Kd_RsACE2 > 1e-5 & dt$Kd_RsACE2 < 1.2e-5)[1])
```
...
plot.titration.RpACE2(which(dt$Kd_RpACE2 > 1e-6 & dt$Kd_RpACE2 < 1.2e-6)[1])
...
```{r nMSR_distribution, fig.width=4, fig.height=4, fig.align="center",dpi=300,dev="png"}
