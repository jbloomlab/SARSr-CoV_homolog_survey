...
For the library 1 RaACE2.787, RpACE2, and RsACE2.3364 titration sorts, the fluorescence boundaries for bins 1-4 are as follows:
...
We successfully generated *K*<sub>D,app</sub> estimates for `r sum(!is.na(dt$Kd_huACE2))` of our lib1 barcodes (`r round(sum(!is.na(dt$Kd_huACE2))/nrow(dt)*100,digits=2)`%) of our lib1+lib2 huACE2 titrations, `r round(sum(!is.na(dt[library=="lib1",Kd_RaACE2.787]))/nrow(dt[library=="lib1",])*100,digits=2)`%) of the RaACE2.787 titrations, `r round(sum(!is.na(dt[library=="lib1",Kd_RpACE2]))/nrow(dt[library=="lib1",])*100,digits=2)`%) of the RpACE2 titrations, and `r round(sum(!is.na(dt[library=="lib1",Kd_RsACE2.3364]))/nrow(dt[library=="lib1",])*100,digits=2)`%) of the RsACE2.3364 titrations.
...
```{r Kd_distribution, fig.width=5, fig.height=18, fig.align="center",dpi=300,dev="png"}
par(mfrow=c(8,1))
...
```{r final_pheno_DFE, fig.width=10, fig.height=20, fig.align="center",dpi=300,dev="png"}
