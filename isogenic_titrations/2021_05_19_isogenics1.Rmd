...
```{r plot_titrations, fig.width=10,fig.height=10,fig.align="center", dpi=500,dev="png",message=FALSE,error=FALSE,warning=FALSE}
annotations <- dt %>%
...
```{r plot_titrations_multi1, fig.width=5,fig.height=2,fig.align="center", dpi=500,dev="png",message=FALSE,error=FALSE,warning=FALSE}
...
AncSarb comparisons:
```{r plot_titrations_multi2, fig.width=10,fig.height=3.5,fig.align="center", dpi=500,dev="png",message=FALSE,error=FALSE,warning=FALSE}
...
AncAsia comparisons:
```{r plot_titrations_multi3, fig.width=10,fig.height=3.5,fig.align="center", dpi=500,dev="png",message=FALSE,error=FALSE,warning=FALSE}
