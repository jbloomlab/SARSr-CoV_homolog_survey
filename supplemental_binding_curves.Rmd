...
plot.titration <- function(homolog,mutation=NA,ACE2,cutoff=10){
  ...
  if(is.na(mutation)){
    ...
    legend("topleft",bty="n",cex=1,legend=paste("log10(Ka)\n",format(Kd_final,digits=4)))
  }
...
#save pdf
if(is.na(mutation)){
  invisible(dev.print(pdf, paste(config$titration_curves_dir,"/",homolog,"_",ACE2,".pdf",sep="")))
}else{
  invisible(dev.print(pdf, paste(config$titration_curves_dir,"/",homolog,"_",mutation,"_",ACE2,".pdf",sep="")))
}
```
