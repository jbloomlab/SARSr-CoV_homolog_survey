...
donut_dt <- data.table(category=c("WT binds","only mut binds","no mut binds"), huACE2=c(10/14,2/14,2/14), cvACE2=c(2/14,7/14,5/14), pgACE2=c(7/14,3/14,4/14), RaACE2.787=c(9/14,3/14,2/14), RaACE2.9479=c(11/14,1/14,2/14), RsACE2.3364=c(4/14,8/14,2/14), RsACE2.1434=c(3/14,5/14,6/14))

#mutate to long
donut_dt <- data.table::melt(donut_dt,id.vars=c("category"),measure.vars=c("huACE2","cvACE2","pgACE2","RaACE2.787","RaACE2.9479","RsACE2.3364","RsACE2.1434"),variable.name="ACE2",value.name="fraction")
