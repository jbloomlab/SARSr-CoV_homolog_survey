...
```{r unfiltered_expression_binding, echo=T, fig.width=10, fig.height=40, fig.align="center", dpi=300,dev="png"}
...
```{r censor_2.5_binding, echo=T, fig.width=10, fig.height=40, fig.align="center", dpi=300,dev="png"}
...
```{r plot_correlations, echo=T, fig.width=20, fig.height=5, fig.align="center", dpi=300,dev="png"}
par(mfrow=c(2,8))
...
```{r n_barcode_plots, echo=T, fig.width=28, fig.height=7, fig.align="center", dpi=300,dev="png"}
par(mfrow=c(2,11))
...
```{r heatmap_wildtypes_all, fig.width=12,fig.height=6,fig.align="center", dpi=500,dev="png",echo=T}
...
```
```{r heatmap_wildtypes_phylogeny, fig.width=12,fig.height=6,fig.align="center", dpi=500,dev="png",echo=T}
#make temp long-form data frame
...
```{r heatmap_wildtypes_MAP-ancestors, fig.width=12,fig.height=6,fig.align="center", dpi=500,dev="png",echo=T}
#make temp long-form data frame
...
```{r heatmap_wildtypes_MAP-and-alt-ancestors, fig.width=12,fig.height=6,fig.align="center", dpi=500,dev="png",echo=T}
#make temp long-form data frame
...
```{r heatmap_SSM_RaACE2.9479, fig.width=18,fig.height=5,fig.align="center", dpi=500,dev="png",echo=T}
...
```
```{r heatmap_SSM_RsACE2.1434, fig.width=18,fig.height=5,fig.align="center", dpi=500,dev="png",echo=T}
...
```{r heatmap_SSM_huACE2_delta_SARS2_reference, fig.width=18,fig.height=5,fig.align="center", dpi=500,dev="png",echo=T}
p1 <- ggplot(dt_mutant,aes(position,mutant))+geom_tile(aes(fill=huACE2_delta_SARS2),color="black",lwd=0.1)+
    #scale_fill_gradientn(colours=c("#A94E35","#A94E35","#F48365","#FFFFFF","#7378B9","#7378B9","#383C6C"),limits=c(-7,7),values=c(0,3/14,5/14,7/14,9/14,11/14,14/14),na.value="yellow")+
  scale_fill_gradientn(colours=c("#A94E35","#F48365","#FFFFFF","#7378B9","#383C6C"),limits=c(-7,7),values=c(0,3.5/14,7/14,10.5/14,14/14),na.value="yellow")+
...
```
```{r heatmap_SSM_RaACE2.9479_delta, fig.width=18,fig.height=5,fig.align="center", dpi=500,dev="png",echo=T}
...
```
```{r heatmap_SSM_RsACE2.1434_delta, fig.width=18,fig.height=5,fig.align="center", dpi=500,dev="png",echo=T}
